...
double distToLine(snlPoint lineStart, snlPoint lineEnd, snlPoint compare)
{
	...
	snlVector lineV = lineEnd - lineStart;

	snlVector testV = compare - lineStart;
							...
							snlPoint& verticeB, snlVector& boundB1, snlVector& boundB2)
{
	...
	snlVector testPointVector = testPt - verticeA;  // Vector from triangle vertice to projected point.
