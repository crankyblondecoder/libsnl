#ifndef SNL_UNIT_TEST_H
#define SNL_UNIT_TEST_H
...
class snlUnitTest
{
	public:
		 ...
		 */
		snlUnitTest(const char* unitTestName);
		 ...
		 */
		void addChildUnitTest(snlUnitTest* childUnitTest);
	...
	private:
		...
		snlUnitTest* _childUnitTests[16];
		...
		snlUnitTest(const snlUnitTest& copyFrom);
		/** Do not allow copying. */
		snlUnitTest& operator= (const snlUnitTest& copyFrom);
};
